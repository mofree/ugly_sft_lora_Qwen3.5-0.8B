...
ds_map = load_from_disk("anime_map") # create_data.py中存的处理好的数据
...
training_args = TrainingArguments(
    ...
    warmup_steps=100,
    weight_decay=0.01,
    logging_dir="./anime_train_output/logs",
    logging_steps=20,
    save_steps=500,
    save_total_limit=2,
    report_to="none",
...
# model.save_pretrained("./lora") # 保存的是adapter_model和adapter_config，和checkpoint里的一样
